...
#define LIGHT_BARRIER   A15  //  
#define LIGHT_BARRIER_LED 47 //NEW!
#define BATT_VOLTAGE    A11 //  Hier liegt 2/5 der Akkuspannung an.

#define POTI            A0  //  hier ist das Potentiometer unten auf der Platine angeschlossen
#define TYPE            A14 //  high bei Roboter A und low bei Roboter B
...
// #define SWITCH_BOTTOM 35  //  Hier wird ausgelesen, ob die Bodensensoren eingeschaltet sind.
...
#define SCHUSS          12   //  Wenn dieser Pin auf HIGH gesetzt wir, fährt der Schuss aus
